    ...
    <section class="error">
      ...
      <div class="error__content">
        ...
        <div class="error__nav">
          <a @click="toHome" target="_blanck" class="e-nav__link">Home Page</a>
        </div>
      </div>
      <!-- END Content -->
    </section>
...
fieldset, form, legend, table, caption, tbody, tfoot, thead, tr, th, td, input {
  border: 0;
  outline: 0;
  font-size: 100%;
  vertical-align: baseline;
...
/*在top-header前面插入元素*/
.top-header:before {
  background-image: url('@/assets/404/header-footer-gradient-bg.png');
}
.top-header:before {
  content: '';
  display: block;
