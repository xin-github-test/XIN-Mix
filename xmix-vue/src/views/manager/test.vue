<template>
  <div>
    <button @click="showView = !showView" style="height: 20px;width: 100px;border:2px solid red">按钮1</button>
  <transition
      v-on:before-enter="beforeEnter"
      v-on:enter="enter"
      v-on:leave="leave"
  >
    <div id="box" style="width: 50px;height: 50px;border: 2px solid red" v-show="showView"></div>
  </transition>
  </div>
</template>
...
export default {
  ...
  methods:{
    ...
    enter (el, done) {
      ...
      Velocity(el, 'transition.slideLeftIn', { duration: 3000,complete:done })
    },
    leave (el, done) {
